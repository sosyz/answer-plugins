...
const (
	InfoName        = "plugin.memory_vector_search.backend.info.name"
	InfoDescription = "plugin.memory_vector_search.backend.info.description"

	ConfigAPIHostTitle       = "plugin.memory_vector_search.backend.config.api_host.title"
	ConfigAPIHostDescription = "plugin.memory_vector_search.backend.config.api_host.description"

	ConfigAPIKeyTitle       = "plugin.memory_vector_search.backend.config.api_key.title"
	ConfigAPIKeyDescription = "plugin.memory_vector_search.backend.config.api_key.description"
